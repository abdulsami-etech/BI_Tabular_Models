CREATE TABLE [SrcSAP].[KNVV] (
    ...
    [PODTG]           DECIMAL (11)    NOT NULL,
    [BLIND]           NVARCHAR (1)    NOT NULL,
    [CARRIER_NOTIF]   NVARCHAR (1)    NOT NULL,
    [CVP_XBLCK_V]     NVARCHAR (1)    NOT NULL,
    [/BEV1/EMLGPFAND] NVARCHAR (1)    NOT NULL,
    [/BEV1/EMLGFORTS] NVARCHAR (1)    NOT NULL,
    [J_1NBOESL]       NVARCHAR (3)    NOT NULL,
    [PROFILE]         NVARCHAR (4)    NOT NULL,
    [FPART]           NVARCHAR (2)    NOT NULL
)
WITH (CLUSTERED INDEX([MANDT], [KUNNR], [VKORG], [VTWEG], [SPART]), DISTRIBUTION = HASH([KUNNR]));
