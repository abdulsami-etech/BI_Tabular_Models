CREATE TABLE [SrcSAP].[LFA1] (
    ...
    [MIN_COMP]        NVARCHAR (1)    NOT NULL,
    [TERM_LI]         NVARCHAR (1)    NOT NULL,
    [CRC_NUM]         NVARCHAR (25)   NOT NULL,
    ...
    [BORGR_DATUN]     NVARCHAR (8)    NOT NULL,
    [BORGR_YEAUN]     NVARCHAR (1)    NOT NULL,
    [TRANSPORT_CHAIN] NVARCHAR (10)   NOT NULL,
    [STAGING_TIME]    DECIMAL (3)     NOT NULL,
    [SCHEDULING_TYPE] NVARCHAR (1)    NOT NULL,
    [SUBMI_RELEVANT]  NVARCHAR (1)    NOT NULL,
    [ZZSUPPLY]        NVARCHAR (1)    NOT NULL,
    [ZZCLASSI]        NVARCHAR (3)    NOT NULL,
    [ZZPAY_PUR]       NVARCHAR (1)    NOT NULL,
    [ZZARB_REL]       NVARCHAR (1)    NOT NULL,
    [ZZARB_ANID]      NVARCHAR (20)   NOT NULL
)
WITH (CLUSTERED INDEX([MANDT], [LIFNR]), DISTRIBUTION = HASH([LIFNR]));
