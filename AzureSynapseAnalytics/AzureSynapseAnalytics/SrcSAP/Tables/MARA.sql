CREATE TABLE [SrcSAP].[MARA] (
    ...
    [MHDHB]            DECIMAL (4)     NOT NULL,
    [MHDLP]            DECIMAL (3)     NOT NULL,
    [INHME]            NVARCHAR (3)    NOT NULL,
    [INHAL]            DECIMAL (13, 3) NOT NULL,
    [VPREH]            DECIMAL (5)     NOT NULL,
    ...
    [ADPROF]           NVARCHAR (3)    NOT NULL,
    [IPMIPPRODUCT]     NVARCHAR (40)   NOT NULL,
    [ALLOW_PMAT_IGNO]  NVARCHAR (1)    NOT NULL,
    [MEDIUM]           NVARCHAR (6)    NOT NULL,
    [COMMODITY]        NVARCHAR (18)   NOT NULL,
    [ANIMAL_ORIGIN]    NVARCHAR (1)    NOT NULL,
    [TEXTILE_COMP_IND] NVARCHAR (1)    NOT NULL,
    [SGT_CSGR]         NVARCHAR (4)    NOT NULL,
    [SGT_COVSA]        NVARCHAR (8)    NOT NULL,
    [SGT_STAT]         NVARCHAR (1)    NOT NULL,
    [SGT_SCOPE]        NVARCHAR (1)    NOT NULL,
    [SGT_REL]          NVARCHAR (1)    NOT NULL,
    [ANP]              NVARCHAR (9)    NOT NULL,
    [FSH_MG_AT1]       NVARCHAR (10)   NOT NULL,
    [FSH_MG_AT2]       NVARCHAR (10)   NOT NULL,
    [FSH_MG_AT3]       NVARCHAR (6)    NOT NULL,
    [FSH_SEALV]        NVARCHAR (1)    NOT NULL,
    [FSH_SEAIM]        NVARCHAR (1)    NOT NULL,
    [FSH_SC_MID]       NVARCHAR (2)    NOT NULL,
    [/BEV1/LULEINH]    NVARCHAR (8)    NOT NULL,
    [/BEV1/LULDEGRP]   NVARCHAR (3)    NOT NULL,
    [/BEV1/NESTRUCCAT] NVARCHAR (1)    NOT NULL,
    [/DSD/SL_TOLTYP]   NVARCHAR (4)    NOT NULL,
    [/DSD/SV_CNT_GRP]  NVARCHAR (10)   NOT NULL,
    [/DSD/VC_GROUP]    NVARCHAR (6)    NOT NULL,
    [/SAPMP/KADU]      DECIMAL (7, 2)  NOT NULL,
    [/SAPMP/ABMEIN]    NVARCHAR (3)    NOT NULL,
    [/SAPMP/KADP]      DECIMAL (5, 2)  NOT NULL,
    [/SAPMP/BRAD]      DECIMAL (4)     NOT NULL,
    [/SAPMP/SPBI]      DECIMAL (7, 2)  NOT NULL,
    [/SAPMP/TRAD]      DECIMAL (7, 2)  NOT NULL,
    [/SAPMP/KEDU]      DECIMAL (7, 2)  NOT NULL,
    [/SAPMP/SPTR]      DECIMAL (13, 3) NOT NULL,
    [/SAPMP/FBDK]      DECIMAL (7, 2)  NOT NULL,
    [/SAPMP/FBHK]      DECIMAL (7, 2)  NOT NULL,
    [/SAPMP/RILI]      NVARCHAR (1)    NOT NULL,
    [/SAPMP/FBAK]      NVARCHAR (1)    NOT NULL,
    [/SAPMP/AHO]       NVARCHAR (3)    NOT NULL,
    [/SAPMP/MIFRR]     DECIMAL (7, 2)  NOT NULL,
    ...
    [PACKCODE]         NVARCHAR (10)   NOT NULL,
    [DG_PACK_STATUS]   NVARCHAR (10)   NOT NULL,
    [MCOND]            NVARCHAR (1)    NOT NULL,
    [RETDELC]          NVARCHAR (1)    NOT NULL,
    [LOGLEV_RETO]      NVARCHAR (1)    NOT NULL,
    [NSNID]            NVARCHAR (9)    NOT NULL,
    [OVLPN]            NVARCHAR (32)   NOT NULL,
    [ADSPC_SPC]        NVARCHAR (1)    NOT NULL,
    [VARID]            NVARCHAR (100)  NOT NULL,
    [MSBOOKPARTNO]     NVARCHAR (18)   NOT NULL,
    [VTYPE]            NVARCHAR (10)   NOT NULL,
    [VCHNR]            NVARCHAR (12)   NOT NULL,
    [EVVAL]            NVARCHAR (1)    NOT NULL,
    [DVERS]            NVARCHAR (18)   NOT NULL,
    [DPCBT]            NVARCHAR (1)    NOT NULL,
    [XGRDT]            NVARCHAR (1)    NOT NULL,
    ...
    [PSM_CODE]         NVARCHAR (2)    NOT NULL
)
WITH (CLUSTERED COLUMNSTORE INDEX, DISTRIBUTION = HASH([MATNR]));
