CREATE TABLE [SrcSAP].[KNA1] (
    ...
    [RG]               NVARCHAR (11)   NOT NULL,
    [EXP]              NVARCHAR (3)    NOT NULL,
    [UF]               NVARCHAR (2)    NOT NULL,
    [RGDATE]           NVARCHAR (8)    NOT NULL,
    [RIC]              NVARCHAR (11)   NOT NULL,
    [RNE]              NVARCHAR (10)   NOT NULL,
    [RNEDATE]          NVARCHAR (8)    NOT NULL,
    [CNAE]             NVARCHAR (7)    NOT NULL,
    [LEGALNAT]         NVARCHAR (4)    NOT NULL,
    [CRTN]             NVARCHAR (1)    NOT NULL,
    [ICMSTAXPAY]       NVARCHAR (2)    NOT NULL,
    [INDTYP]           NVARCHAR (2)    NOT NULL,
    [TDT]              NVARCHAR (2)    NOT NULL,
    [COMSIZE]          NVARCHAR (2)    NOT NULL,
    [DECREGPC]         NVARCHAR (2)    NOT NULL,
    ...
    [FEE_SCHEDULE]     NVARCHAR (4)    NOT NULL,
    [DUNS]             NVARCHAR (9)    NOT NULL,
    [DUNS4]            NVARCHAR (4)    NOT NULL,
    ...
    [J_3GETYP]         NVARCHAR (2)    NOT NULL,
    [J_3GREFTYP]       NVARCHAR (2)    NOT NULL,
    [PSPNR]            NVARCHAR (8)    NOT NULL,
    [COAUFNR]          NVARCHAR (12)   NOT NULL,
    [J_3GAGEXT]        NVARCHAR (10)   NOT NULL,
    [J_3GAGINT]        NVARCHAR (10)   NOT NULL,
    [J_3GAGDUMI]       NVARCHAR (10)   NOT NULL,
    [J_3GAGSTDI]       NVARCHAR (10)   NOT NULL,
    [LGORT]            NVARCHAR (4)    NOT NULL,
    [KOKRS]            NVARCHAR (4)    NOT NULL,
    [KOSTL]            NVARCHAR (10)   NOT NULL,
    [J_3GABGLG]        NVARCHAR (1)    NOT NULL,
    [J_3GABGVG]        NVARCHAR (1)    NOT NULL,
    [J_3GABRART]       NVARCHAR (1)    NOT NULL,
    [J_3GSTDMON]       DECIMAL (5, 2)  NOT NULL,
    [J_3GSTDTAG]       DECIMAL (5, 2)  NOT NULL,
    [J_3GTAGMON]       DECIMAL (5, 2)  NOT NULL,
    [J_3GZUGTAG]       NVARCHAR (1)    NOT NULL,
    [J_3GMASCHB]       NVARCHAR (1)    NOT NULL,
    [J_3GMEINSA]       NVARCHAR (1)    NOT NULL,
    [J_3GKEINSA]       NVARCHAR (1)    NOT NULL,
    [J_3GBLSPER]       NVARCHAR (1)    NOT NULL,
    [J_3GKLEIVO]       NVARCHAR (1)    NOT NULL,
    [J_3GCALID]        NVARCHAR (2)    NOT NULL,
    [J_3GVMONAT]       NVARCHAR (1)    NOT NULL,
    [J_3GABRKEN]       NVARCHAR (1)    NOT NULL,
    [J_3GLABRECH]      NVARCHAR (8)    NOT NULL,
    [J_3GAABRECH]      NVARCHAR (8)    NOT NULL,
    [J_3GZUTVHLG]      NVARCHAR (1)    NOT NULL,
    [J_3GNEGMEN]       NVARCHAR (1)    NOT NULL,
    [J_3GFRISTLO]      NVARCHAR (1)    NOT NULL,
    [J_3GEMINBE]       NVARCHAR (5)    NOT NULL,
    [J_3GFMGUE]        NVARCHAR (5)    NOT NULL,
    [J_3GZUSCHUE]      NVARCHAR (5)    NOT NULL,
    [J_3GSCHPRS]       NVARCHAR (1)    NOT NULL,
    [J_3GINVSTA]       NVARCHAR (1)    NOT NULL,
    [/SAPCEM/DBER]     NVARCHAR (8)    NOT NULL,
    [/SAPCEM/KVMEQ]    NVARCHAR (1)    NOT NULL
)
WITH (CLUSTERED COLUMNSTORE INDEX, DISTRIBUTION = HASH([KUNNR]));
