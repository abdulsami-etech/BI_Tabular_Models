CREATE TABLE [SrcSAP].[VBRK] (
    ...
    [J_3GKENIE]       NVARCHAR (1)    NOT NULL,
    [KUNWE]           NVARCHAR (10)   NOT NULL,
    [MNDID]           NVARCHAR (35)   NOT NULL,
    [PAY_TYPE]        NVARCHAR (1)    NOT NULL,
    [SEPON]           NVARCHAR (1)    NOT NULL,
    [MNDVG]           NVARCHAR (1)    NOT NULL,
    [SPPAYM]          NVARCHAR (2)    NOT NULL,
    [SPPORD]          NVARCHAR (10)   NOT NULL,
    [ZZDER_SHFRM]     NVARCHAR (3)    NOT NULL,
    [ZZLANDX]         NVARCHAR (15)   NOT NULL,
    [ZZLANDX50]       NVARCHAR (50)   NOT NULL,
    [ZLOC]            NVARCHAR (3)    NOT NULL,
    [ZVAT_NO]         NVARCHAR (16)   NOT NULL,
    [ZVAT_DT]         NVARCHAR (8)    NOT NULL,
    [ZVAT_AMT]        DECIMAL (15, 2) NOT NULL
)
