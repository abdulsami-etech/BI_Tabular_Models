CREATE VIEW [TABIRIS].[DimTicketTraining] AS SELECT
	t.[SKTicketTraining]																			as [SK Ticket Training],
	t.[KeyTicketTraining]																			as [Key Ticket Training],
	...
	convert(date, convert(varchar(8), t.[TrainingDateKey]), 112)									as [Training Date],
	convert(datetime, t.[TrainingDate])																as [Training Date Time],
	t.[TrackStatus]																					as [Track Status],
	a.AccountNumber																					as [Account Number],
	t.ParentTicketNumber																			as [Parent Ticket Number],
	t.IssueType																						as [IssueType],
	t.TicketType																					as [TicketType]
FROM [DWIRIS].[DimTicketTraining] t
