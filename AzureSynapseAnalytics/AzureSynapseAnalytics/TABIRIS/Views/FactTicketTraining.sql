CREATE VIEW [TABIRIS].[FactTicketTraining]
AS SELECT
	f.[SKTicketTraining]							as [SK Ticket Training],
	...
	convert(date, convert(varchar(8), f.[TrainingDateKey]), 112)										as [Training Date],
...
FROM [DWIRIS].[DimTicketTraining] f;