CREATE VIEW [SrcMES_AFAB_MX2].[SrcFactCaseStateHistory]
AS SELECT a.adlsbatchid                              AS ADLSBatchID, 
       ...
       'MES_AFAB_MX2'                                AS [SourceSystem] 
FROM   [SrcMES_AFAB_MX2].[tracked_object_history] AS a 
       INNER JOIN [SrcMES_AFAB_MX2].[lot] AS b 
               ON a.[tobj_key] = b.lot_key 
       INNER JOIN [SrcMES_AFAB_MX2].[work_order] AS c 
