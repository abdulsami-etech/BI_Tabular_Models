...
BEGIN IF OBJECT_ID('[DWSAP].[VBAPH]', 'U') IS NOT NULL 
DROP 
  TABLE [DWSAP].[VBAPH] IF OBJECT_ID(
    'TEMPDB..#temp_ScannerHistory_Performance', 
    'U'
  ) IS NOT NULL 
DROP 
  TABLE #temp_ScannerHistory_Performance
...
SELECT 
  ...
  VBAP.[Free_Paid] INTO #temp_ScannerHistory_Performance
FROM 
...
SELECT 
  * 
FROM 
  #temp_ScannerHistory_Performance END ELSE BEGIN
SELECT 
  * INTO [DWSAP].[ScannerHistoryProcessed_Performance] 
FROM 
  #temp_ScannerHistory_Performance END
DROP 
  TABLE #temp_ScannerHistory_Performance IF OBJECT_ID('[DWSAP].[VBAPH]',
  'U'
) IS NOT NULL 
DROP 
