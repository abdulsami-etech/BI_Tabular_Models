CREATE PROC [DWCONSDL].[LoadFactGAUMsCTD] @BatchID [int],@LastSuccessfullDWTimestamp [datetime2](0),@IsForceFullLoad [bit] AS
begin
	set nocount on
	set xact_abort on
	set datefirst 1;
	...
	if object_id('tempdb..#TempFactGAUMsCTD') is not null
		drop table #TempFactGAUMsCTD


create table #TempFactGAUMsCTD (
...
SET @MaxCounterEMEA = DATEDIFF(dd, @CurrentMinDateEMEA, @CurrentSMaxDateEMEA)
...
update #TempFactGAUMsCTD set DWHashKey =
		convert(char(40),
	...
	from #TempFactGAUMsCTD src
	where DWCONSDL.FactGAUMsCTD.DWHashKey = src.DWHashKey
		and DWCONSDL.FactGAUMsCTD.DWHash != src.DWHash
	option (label = 'DWCONSDL.LoadFactGAUMsCTD_Update_EMEA');
	
	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Update_EMEA', @rc = @RowsUpdated_EMEA out
	...
	option (label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_EMEA');

	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_EMEA', @rc = @RowsInserted_EMEA out
...
-- CANADA REGION
TRUNCATE TABLE #TempFactGAUMsCTD
...
SET @MaxCounterCANADA = DATEDIFF(dd, @CurrentMinDateCANADA, @CurrentSMaxDateCANADA)
...
update #TempFactGAUMsCTD set DWHashKey =
	...
	where DWCONSDL.FactGAUMsCTD.DWHashKey = src.DWHashKey
		and DWCONSDL.FactGAUMsCTD.DWHash != src.DWHash
	option (label = 'DWCONSDL.LoadFactGAUMsCTD_Update');
	
	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Update_CANADA', @rc = @RowsUpdated_CANADA out
	...
	from #TempFactGAUMsCTD src
	where not exists(select * from DWCONSDL.FactGAUMsCTD dst where dst.DWHashKey = src.DWHashKey)
	option (label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_CANADA');

	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_CANADA', @rc = @RowsInserted_CANADA out
...
SET @MaxCounterUS = DATEDIFF(dd, @CurrentMinDateUS, @CurrentSMaxDateUS)
...
update #TempFactGAUMsCTD set DWHashKey =
	...
	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Update_US', @rc = @RowsUpdated_US out
	...
	from #TempFactGAUMsCTD src
	where not exists(select * from DWCONSDL.FactGAUMsCTD dst where dst.DWHashKey = src.DWHashKey)
	option (label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_US');

	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_US', @rc = @RowsInserted_US out
...
SET @MaxCounterBRAZIL = DATEDIFF(dd, @CurrentMinDateBRAZIL, @CurrentSMaxDateBRAZIL)
...
update #TempFactGAUMsCTD set DWHashKey =
	...
	where DWCONSDL.FactGAUMsCTD.DWHashKey = src.DWHashKey
		and DWCONSDL.FactGAUMsCTD.DWHash != src.DWHash
	option (label = 'DWCONSDL.LoadFactGAUMsCTD_Update_BRAZIL');
	
	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Update_BRAZIL', @rc = @RowsUpdated_BRAZIL out
	...
	from #TempFactGAUMsCTD src
	where not exists(select * from DWCONSDL.FactGAUMsCTD dst where dst.DWHashKey = src.DWHashKey)
	option (label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_BRAZIL');

	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_BRAZIL', @rc = @RowsInserted_BRAZIL out
...
SET @MaxCounterAPAC = DATEDIFF(dd, @CurrentMinDateAPAC, @CurrentSMaxDateAPAC)
...
update #TempFactGAUMsCTD set DWHashKey =
	...
	where DWCONSDL.FactGAUMsCTD.DWHashKey = src.DWHashKey
		and DWCONSDL.FactGAUMsCTD.DWHash != src.DWHash
	option (label = 'DWCONSDL.LoadFactGAUMsCTD_Update_APAC');
	
	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Update_APAC', @rc = @RowsUpdated_APAC out
	...
	from #TempFactGAUMsCTD src
	where not exists(select * from DWCONSDL.FactGAUMsCTD dst where dst.DWHashKey = src.DWHashKey)
	option (label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_APAC');

	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_APAC', @rc = @RowsInserted_APAC out
...
SET @MaxCounterLATAM = DATEDIFF(dd, @CurrentMinDateLATAM, @CurrentSMaxDateLATAM)
...
update #TempFactGAUMsCTD set DWHashKey =
	...
	where DWCONSDL.FactGAUMsCTD.DWHashKey = src.DWHashKey
		and DWCONSDL.FactGAUMsCTD.DWHash != src.DWHash
	option (label = 'DWCONSDL.LoadFactGAUMsCTD_Update_LATAM');
	
	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Update_LATAM', @rc = @RowsUpdated_LATAM out
	...
	from #TempFactGAUMsCTD src
	where not exists(select * from DWCONSDL.FactGAUMsCTD dst where dst.DWHashKey = src.DWHashKey)
	option (label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_LATAM');

	exec CTRL.GetLastRowCount @Label = 'DWCONSDL.LoadFactGAUMsCTD_Insert_LATAM', @rc = @RowsInserted_LATAM out
