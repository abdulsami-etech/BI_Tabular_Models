create procedure [CTRL].[ADLCreateTempTable] @ObjectName varchar(128), @jsonTableStructure varchar(max), @ColumnList varchar(max) = null
as
begin
	set nocount on
	...
	set @SQL = 'create table ' + @tempTableName + '(' + @Columns + ')'
	exec (@SQL)
